...
## Result
### 歌词
数据集大小为**17.4MB**，使用**fp32**精度微调，微调了**15**轮，输出长度为**1024**。测试了**8**种不同风格的歌词，分别为**浪漫**、**伤感**、**治愈**、**怀旧**、**说唱**、**古风**、**快乐**、**思念**。从测试结果来看，**第11轮**的效果较好。**8**个结果放置于**results/lyric_fp32_27layer_eod_eod_10epoch_best**目录下。展示其中**两种**效果：
